...
All error subclasses inherit from <TypeTooltip name="IMessageError" type={`declare class IMessageError extends Error {
...
<Accordion title="IMessageError properties" description="Base error for every failure surfaced by the SDK.">
