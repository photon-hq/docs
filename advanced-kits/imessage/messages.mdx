...
<Note>
  All event streams send periodic heartbeat signals to keep long-lived connections alive through proxies like Cloudflare Tunnel. Heartbeats are handled transparently and do not appear as typed events.
</Note>
