---
title: Architecture
description: Patterns for building human-feeling agents on Spectrum
---
...
- [Outbound pacing](/best-practices/outbound-pacing) - typing simulation, splitting one reply into multiple messages, and giving the model control over beats.
