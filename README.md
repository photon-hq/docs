...
The **API reference** tab's `Endpoints` group is generated by Mintlify from
...
The **WebSocket** group includes eight protocol guides and a frame reference.
...
both native rendering and the download on the hosted build after deployment.
