...
![Photon Voice page showing an SMS number under Lines and the Set up default button highlighted.](/images/cookbooks/voice/retell/Voice1.webp)
...
![Create the default profile page with SIP selected and the Create profile button highlighted.](/images/cookbooks/voice/retell/create-default-profile.webp)
...
![Created Default profile showing SIP, one line, and inbound and outbound calls not enabled.](/images/cookbooks/voice/retell/Voice3.webp)
...
![Photon Outbound calls section showing the Digest algorithm choices and Enable outbound button.](/images/cookbooks/voice/retell/voice_outbound_1.webp)

![Photon one-time outbound password dialog with the password concealed and the I saved it button.](/images/cookbooks/voice/retell/voice_outbound_2.webp)
...
![Photon outbound settings showing the username, authentication realm, SHA-256, and the production SIP connection sip.photon.codes with its ports.](/images/cookbooks/voice/retell/photon-outbound-configured.webp)
...
![Retell Phone Numbers page with the add button highlighted.](/images/cookbooks/voice/retell/add-number.webp)

Select **Connect to your number via SIP trunking**.

![The add-number menu with Connect to your number via SIP trunking highlighted.](/images/cookbooks/voice/retell/choose-sip-trunking.webp)

In the dialog, enter the details for your Photon number and its Voice profile.

![Retell connection form with a concealed Photon number, sip.photon.codes as the termination URI, Photon Voice Demo as the nickname, and TLS selected. The credential fields are empty.](/images/cookbooks/voice/retell/connection-details.webp)
...
![Imported Photon number in Retell with both call-agent selectors initially set to None.](/images/cookbooks/voice/retell/number-agent-settings.webp)
...
![Inbound Call Agent menu showing the Photon Voice Demo Agent and version V0 selected.](/images/cookbooks/voice/retell/select-agent-version.webp)
...
![Photon Inbound calls section with Enable inbound highlighted.](/images/cookbooks/voice/retell/voice_inbound_1.webp)
...
![Photon inbound form showing the SIP address, transport selector, and optional authentication fields before configuration.](/images/cookbooks/voice/retell/voice_inbound_2.webp)
...
![Photon inbound enabled with destination sips:sip.retellai.com, TLS selected, and no SIP credentials.](/images/cookbooks/voice/retell/photon-inbound-configured.webp)
...
![Retell number page with inbound and outbound agents selected and Make an outbound call highlighted.](/images/cookbooks/voice/retell/make-outbound-call.webp)
...
![Make Outbound Call dialog showing the recipient number, Dynamic Variables, Custom SIP Headers, and Call button.](/images/cookbooks/voice/retell/outbound-call-dialog.webp)
