...
<Note>
  This reference uses the production API at `https://api.photon.codes`,
  including requests sent from the interactive playground.
</Note>
...
<Warning>
  The playground sends real requests to production. Use a credential scoped to
  the project you intend to work with, and revoke temporary credentials when you
  are done.
</Warning>
...
and lets you send a request to the production API.
